...
$toemails[] = array(
				'email' => 'hr@infocuscs.com', // Your Email Address
				'name' => 'Infocus HR' // Your Name
			);
...
$fromemail = array(
				'email' => 'hr@infocuscs.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Infocus Consulting Services' // Company Name
			);
